function varargout = BHGMsimulatorAP2009(varargin)

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @BHGMsimulatorAP2009_OpeningFcn, ...
                   'gui_OutputFcn',  @BHGMsimulatorAP2009_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function BHGMsimulatorAP2009_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = hObject;
guidata(hObject, handles);

function varargout = BHGMsimulatorAP2009_OutputFcn(hObject, eventdata, handles) 
